...
class k_line(Frame):
    ...
    def get_k_line_data(self,day):
        ...
        sample_k=pd.read_excel('C:/Users/Eeway/Documents/GitHub/Debris/My_work_undone_pieces/daily_k.xlsx')
    ...
    def get_real_time_quote_k_data(self):
        ...
        real_time_quote_k_data=pd.read_excel('C:/Users/Eeway/Documents/GitHub/Debris/My_work_undone_pieces/real_time_quote.xlsx')
    ...
    def draw_k_line(self):
        ...
        self.pic.set_title('this is sz000001!') 
...
if __name__ =='__main__' :
    def main():     
        ...
        refresher = Button(Frame_1,text = 'press me!',command = to_k_line.start)
        refresher.grid()
        to_k_line.canvas=FigureCanvasTkAgg(to_k_line.figure_default,Frame_1)
        to_k_line.canvas.draw()
        to_k_line.canvas.get_tk_widget().grid()
        
        Label(Frame_Default_1,text='portfolio').pack()
